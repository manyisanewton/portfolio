...
import { 
  FaLinkedin, FaGithub, FaEnvelope, FaFacebookF, FaPhone, 
  FaMapMarkerAlt, FaReact, FaBolt 
} from 'react-icons/fa';
            ...
            <ul className="space-y-3">
              {usefulLinks.map(link => (
                <li key={link}>
                  ...
                  >
                    {/* SEO-friendly hybrid link */}
                    <a href={`#${link.toLowerCase()}`} className="block w-full h-full">
                      {link}
                    </a>
                  </Link>
                </li>
            ...
            <div className="flex flex-wrap justify-center md:justify-start gap-4">
              {siteCraftsmanship.map((tech) => (
                <div
                  ...
                  onMouseLeave={handleMouseLeave}
                >
                  <div className="bg-gray-800 p-3 rounded-full text-cyan-400" aria-hidden="true">
                    {tech.icon}
                  </div>
